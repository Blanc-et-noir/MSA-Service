...
public enum BookServiceCode implements Code{
	...
	BOOK_NOT_RESERVABLE_DUE_TO_BOOK_STATUS("BOOK_NOT_RESERVABLE_DUE_TO_BOOK_STATUS","해당 도서는 예약할 수 있는 상태가 아닙니다.",HttpStatus.BAD_REQUEST),
	BOOK_NOT_RESERVABLE_DUE_TO_MEMBER_ID("BOOK_NOT_RESERVABLE_DUE_TO_MEMBER_ID","자신이 등록한 도서는 예약할 수 없습니다.",HttpStatus.BAD_REQUEST);
